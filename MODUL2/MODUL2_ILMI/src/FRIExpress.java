public class FRIExpress extends Ekspedisi
{
    ...
    public void informasi(){
        System.out.println("Ekspedisi FRIExpress dengan jumlah cabang " + jumlahCabang + " dan berpusat di " + pusat +  " mempunyai tarif " + tarif + " perkilogram.");
        if(pecahBelah == false){
            System.out.println("Selain itu, ekspedisi ini tidak melayani paket pecahbelah");
        }
        else{
            System.out.println("Selain itu, ekspedisi ini melayani paket pecahbelah");
        }
    }
